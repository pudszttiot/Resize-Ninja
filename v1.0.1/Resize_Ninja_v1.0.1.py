...
class ResizeNinja(QMainWindow):
    def __init__(self):
        ...
        self.choose_button.setFont(QFont("Arial", 12))  # Set font style and size
        ...
        self.choose_output_button.setFont(QFont("Arial", 12))  # Set font style and size
        ...
        self.dimension_var.setFont(QFont("Arial", 10))  # Set font style and size
        ...
        self.custom_width_label.setFont(QFont("Arial", 10))  # Set font style and size
        ...
        self.custom_height_label.setFont(QFont("Arial", 10))  # Set font style and size
        ...
        self.format_var.setFont(QFont("Arial", 10))  # Set font style and size
        ...
        self.resize_button.setFont(QFont("Arial", 12))  # Set font style and size
    ...
    def about(self):
        version_info = "Resize Ninja v1.1\nDeveloped by pudszTTIOT"
